...
- 📊 Shiny/Quarto Interactive Dashboard - dashboard allowing for dynamic exploration of our analysis.

## Tools & Packages
- R - tidyverse, ggplot2, gganimate, leaflet
- Quarto - report and dashboard
- Shiny
- API - api-ninjas.com Air Quality API
